...
- **Management API**
  - `Auth0\APIs\Management\Users`
    - Support for the `DELETE /users/:id/authenticators` endpoint using `deleteAllAuthenticators()` ([#702](https://github.com/auth0/auth0-PHP/pull/702)). ([Documentation](https://auth0.github.io/auth0-PHP/API/Management/Management.html#method-deleteAllAuthenticators))
