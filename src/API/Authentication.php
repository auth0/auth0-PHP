...
class Authentication
{
  ...
  public function get_authorize_link(
    ...
    $additional_params['client_id'] = $this->_client_id;
    ...
    return "https://{$this->_domain}/authorize?{$query_string}";
  }
  ...
  {
    return "https://{$this->_domain}/samlp/$client_id?connection=$connection";
  }
  ...
  {
    return "https://{$this->_domain}/samlp/metadata/$client_id";
  }
  ...
  {
    return "https://{$this->_domain}/wsfed/$client_id";
  }
  ...
  public function get_logout_link(
    ...
    return "https://{$this->_domain}/v2/logout?$query_string";
  }
  ...
  public function oauth_token( $options = [] )
  {
    if (! isset($options['client_id'])) {
      $options['client_id'] = $this->_client_id;
    }

    if (! isset($options['client_secret'])) {
      $options['client_secret'] = $this->_client_secret;
    }
  ...
  public function client_credentials( $options )
  {
    ...
    if (!isset($options['scope'])) {
      $options['scope'] = $this->_scope;
    }
    if (!isset($options['audience'])) {
      $options['audience'] = $this->_audience;
    }
