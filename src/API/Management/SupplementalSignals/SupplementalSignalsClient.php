...
class SupplementalSignalsClient implements SupplementalSignalsClientInterface
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    public function get(?array $options = null): ?GetSupplementalSignalsResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetSupplementalSignalsResponseContent::fromJson($json);
            }
    ...
    public function patch(UpdateSupplementalSignalsRequestContent $request, ?array $options = null): ?PatchSupplementalSignalsResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return PatchSupplementalSignalsResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
