...
use Auth0\SDK\API\Management\Types\ConnectionProtocolBindingEnumSaml;
use Auth0\SDK\API\Management\Types\ConnectionSetUserRootAttributesEnum;
use Auth0\SDK\API\Management\Types\ConnectionSignatureAlgorithmEnumSaml;
 ...
 *   |string
 * )|null $decryptionKey
 * @property ?value-of<ConnectionDigestAlgorithmEnumSaml> $digestAlgorithm
 * @property ?array<string> $domainAliases
 * @property ?string $entityId
 * @property ?string $iconUrl
 * @property ?ConnectionOptionsIdpinitiatedSaml $idpinitiated
 * @property ?value-of<ConnectionProtocolBindingEnumSaml> $protocolBinding
 * @property ?value-of<ConnectionSetUserRootAttributesEnum> $setUserRootAttributes
 * @property ?string $signInEndpoint
 * @property ?bool $signSamlRequest
