...
namespace Auth0\SDK\API\Management\Prompts\Requests;

use Auth0\SDK\API\Management\Core\Json\JsonSerializableType;
use Auth0\SDK\API\Management\Types\UniversalLoginExperienceEnum;
use Auth0\SDK\API\Management\Core\Json\JsonProperty;

class UpdateSettingsRequestContent extends JsonSerializableType
{
    /**
