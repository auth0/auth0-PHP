...
class CreatePhoneTemplateTestNotificationRequestContent extends JsonSerializableType
{
    /**
     * @var string $to Destination of the testing phone notification
     */
    #[JsonProperty('to')]
    private string $to;

    /**
     * @var ?value-of<PhoneProviderDeliveryMethodEnum> $deliveryMethod Medium to use to send the notification
     */
