...
class RegisterCimdClientRequestContent extends JsonSerializableType
{
    /**
     * @var string $externalClientId URL to the Client ID Metadata Document. Acts as the unique identifier for upsert operations.
     */
