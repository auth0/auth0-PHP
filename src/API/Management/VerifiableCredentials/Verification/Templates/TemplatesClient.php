...
use Auth0\SDK\API\Management\Types\ListVerifiableCredentialTemplatesPaginatedResponseContent;
...
class TemplatesClient implements TemplatesClientInterface
{
    ...
    public function list(ListVerifiableCredentialTemplatesRequestParameters $request = new ListVerifiableCredentialTemplatesRequestParameters(), ?array $options = null): Pager
    {
        return new CursorPager(
            request: $request,
            getNextPage: fn (ListVerifiableCredentialTemplatesRequestParameters $request) => $this->_list($request, $options),
            setCursor: function (ListVerifiableCredentialTemplatesRequestParameters $request, ?string $cursor) {
                $request->setFrom($cursor);
            },
            /* @phpstan-ignore-next-line */
            getNextCursor: fn (?ListVerifiableCredentialTemplatesPaginatedResponseContent $response) => $response?->getNext() ?? null,
            /* @phpstan-ignore-next-line */
            getItems: fn (?ListVerifiableCredentialTemplatesPaginatedResponseContent $response) => $response?->getTemplates() ?? [],
        );
    }
    ...
    public function create(CreateVerifiableCredentialTemplateRequestContent $request, ?array $options = null): ?CreateVerifiableCredentialTemplateResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return CreateVerifiableCredentialTemplateResponseContent::fromJson($json);
            }
    ...
    public function get(string $id, ?array $options = null): ?GetVerifiableCredentialTemplateResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetVerifiableCredentialTemplateResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
    ...
    public function update(string $id, UpdateVerifiableCredentialTemplateRequestContent $request = new UpdateVerifiableCredentialTemplateRequestContent(), ?array $options = null): ?UpdateVerifiableCredentialTemplateResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return UpdateVerifiableCredentialTemplateResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return ?ListVerifiableCredentialTemplatesPaginatedResponseContent
     * @throws Auth0Exception
     * @throws Auth0ApiException
     */
    private function _list(ListVerifiableCredentialTemplatesRequestParameters $request = new ListVerifiableCredentialTemplatesRequestParameters(), ?array $options = null): ?ListVerifiableCredentialTemplatesPaginatedResponseContent
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListVerifiableCredentialTemplatesPaginatedResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
