...
namespace Auth0\SDK\API\Management\ClientGrants\Organizations\Requests;

use Auth0\SDK\API\Management\Core\Json\JsonSerializableType;

class ListClientGrantOrganizationsRequestParameters extends JsonSerializableType
{
    /**
