...
use Auth0\SDK\API\Management\RiskAssessments\Settings\NewDevice\NewDeviceClient;
...
class SettingsClient implements SettingsClientInterface
{
    /**
     * @var NewDeviceClient $newDevice
     */
    ...
    public function __construct(
        ...
        $this->newDevice = new NewDeviceClient($this->client, $this->options);
    }
    ...
    public function get(?array $options = null): ?GetRiskAssessmentsSettingsResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetRiskAssessmentsSettingsResponseContent::fromJson($json);
            }
    ...
    public function update(UpdateRiskAssessmentsSettingsRequestContent $request, ?array $options = null): ?UpdateRiskAssessmentsSettingsResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return UpdateRiskAssessmentsSettingsResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
