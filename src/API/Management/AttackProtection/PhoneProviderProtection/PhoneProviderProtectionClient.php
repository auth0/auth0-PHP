...
class PhoneProviderProtectionClient implements PhoneProviderProtectionClientInterface
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    public function get(?array $options = null): ?GetPhoneProviderProtectionResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetPhoneProviderProtectionResponseContent::fromJson($json);
            }
    ...
    public function patch(PatchPhoneProviderProtectionRequestContent $request, ?array $options = null): ?PatchPhoneProviderProtectionResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return PatchPhoneProviderProtectionResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
