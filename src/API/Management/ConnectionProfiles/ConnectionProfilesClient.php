...
use Auth0\SDK\API\Management\Types\ListConnectionProfilesPaginatedResponseContent;
...
class ConnectionProfilesClient implements ConnectionProfilesClientInterface
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    public function list(ListConnectionProfileRequestParameters $request = new ListConnectionProfileRequestParameters(), ?array $options = null): Pager
    {
        return new CursorPager(
            request: $request,
            getNextPage: fn (ListConnectionProfileRequestParameters $request) => $this->_list($request, $options),
            setCursor: function (ListConnectionProfileRequestParameters $request, ?string $cursor) {
                $request->setFrom($cursor);
            },
            /* @phpstan-ignore-next-line */
            getNextCursor: fn (?ListConnectionProfilesPaginatedResponseContent $response) => $response?->getNext() ?? null,
            /* @phpstan-ignore-next-line */
            getItems: fn (?ListConnectionProfilesPaginatedResponseContent $response) => $response?->getConnectionProfiles() ?? [],
        );
    }
    ...
    public function create(CreateConnectionProfileRequestContent $request, ?array $options = null): ?CreateConnectionProfileResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return CreateConnectionProfileResponseContent::fromJson($json);
            }
    ...
    public function listTemplates(?array $options = null): ?ListConnectionProfileTemplateResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListConnectionProfileTemplateResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
    ...
    public function getTemplate(string $id, ?array $options = null): ?GetConnectionProfileTemplateResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetConnectionProfileTemplateResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
    ...
    public function get(string $id, ?array $options = null): ?GetConnectionProfileResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetConnectionProfileResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
    ...
    public function update(string $id, UpdateConnectionProfileRequestContent $request = new UpdateConnectionProfileRequestContent(), ?array $options = null): ?UpdateConnectionProfileResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return UpdateConnectionProfileResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return ?ListConnectionProfilesPaginatedResponseContent
     * @throws Auth0Exception
     * @throws Auth0ApiException
     */
    private function _list(ListConnectionProfileRequestParameters $request = new ListConnectionProfileRequestParameters(), ?array $options = null): ?ListConnectionProfilesPaginatedResponseContent
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListConnectionProfilesPaginatedResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
