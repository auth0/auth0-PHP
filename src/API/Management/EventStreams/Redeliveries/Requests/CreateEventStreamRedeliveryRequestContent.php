...
namespace Auth0\SDK\API\Management\EventStreams\Redeliveries\Requests;

use Auth0\SDK\API\Management\Core\Json\JsonSerializableType;
use DateTime;
use Auth0\SDK\API\Management\Core\Json\JsonProperty;
use Auth0\SDK\API\Management\Core\Types\Date;
use Auth0\SDK\API\Management\Types\EventStreamDeliveryStatusEnum;
use Auth0\SDK\API\Management\Core\Types\ArrayType;
use Auth0\SDK\API\Management\Types\EventStreamEventTypeEnum;

class CreateEventStreamRedeliveryRequestContent extends JsonSerializableType
{
    /**
