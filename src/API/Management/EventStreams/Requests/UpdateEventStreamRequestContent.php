...
use Auth0\SDK\API\Management\Types\EventStreamSubscription;
use Auth0\SDK\API\Management\Core\Types\ArrayType;
use Auth0\SDK\API\Management\Types\EventStreamWebhookDestination;
use Auth0\SDK\API\Management\Types\EventStreamActionDestination;
use Auth0\SDK\API\Management\Core\Types\Union;
use Auth0\SDK\API\Management\Types\EventStreamStatusEnum;

class UpdateEventStreamRequestContent extends JsonSerializableType
{
    /**
     ...
     * )|null $destination
     */
    #[JsonProperty('destination'), Union(EventStreamWebhookDestination::class, EventStreamActionDestination::class, 'null')]
    private EventStreamWebhookDestination|EventStreamActionDestination|null $destination;
     ...
     * )|null
     */
    public function getDestination(): EventStreamWebhookDestination|EventStreamActionDestination|null
    {
     ...
     * )|null $value
     */
    public function setDestination(EventStreamWebhookDestination|EventStreamActionDestination|null $value = null): self
    {
