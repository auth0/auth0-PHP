...
class ErrorsClient implements ErrorsClientInterface
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    public function get(string $id, ?array $options = null): array|GetJobGenericErrorResponseContent|null
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return JsonDecoder::decodeUnion($json, new Union([GetJobErrorResponseContent::class], GetJobGenericErrorResponseContent::class)); // @phpstan-ignore-line
            }
