...
class CreateResourceServerRequestContent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?bool $enforcePolicies Whether to enforce authorization policies (true) or to ignore them (false).
     */
