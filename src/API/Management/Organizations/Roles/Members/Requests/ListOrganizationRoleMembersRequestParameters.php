...
namespace Auth0\SDK\API\Management\Organizations\Roles\Members\Requests;

use Auth0\SDK\API\Management\Core\Json\JsonSerializableType;

class ListOrganizationRoleMembersRequestParameters extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?int $take Number of results per page. Defaults to 50. Values above the maximum permitted size are capped.
     */
    private ?int $take = 50;
     ...
     */
    private ?bool $includeFields = true;
