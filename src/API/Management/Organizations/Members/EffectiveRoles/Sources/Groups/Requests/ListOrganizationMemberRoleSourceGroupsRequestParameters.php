...
namespace Auth0\SDK\API\Management\Organizations\Members\EffectiveRoles\Sources\Groups\Requests;

use Auth0\SDK\API\Management\Core\Json\JsonSerializableType;

class ListOrganizationMemberRoleSourceGroupsRequestParameters extends JsonSerializableType
{
    /**
    ...
    /**
     * @var string $roleId The role ID to get group sources for.
     */
