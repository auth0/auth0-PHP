...
namespace Auth0\SDK\API\Management\Organizations\Members\EffectiveRoles\Requests;

use Auth0\SDK\API\Management\Core\Json\JsonSerializableType;

class ListOrganizationMemberEffectiveRolesRequestParameters extends JsonSerializableType
{
    /**
