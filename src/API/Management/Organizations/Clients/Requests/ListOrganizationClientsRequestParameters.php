...
class ListOrganizationClientsRequestParameters extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?int $take Number of results per page. Defaults to 50. Values greater than the maximum of 100 are capped at 100.
     */
    private ?int $take = 50;
