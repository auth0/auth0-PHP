        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    ...
                    path: "organizations/" . RawClient::encodePathParam($id) . "/discovery-domains",
    ...
    public function getByName(string $id, string $discoveryDomain, ?array $options = null): ?GetOrganizationDiscoveryDomainByNameResponseContent
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "organizations/" . RawClient::encodePathParam($id) . "/discovery-domains/name/" . RawClient::encodePathParam($discoveryDomain),
    ...
    public function get(string $id, string $discoveryDomainId, ?array $options = null): ?GetOrganizationDiscoveryDomainResponseContent
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "organizations/" . RawClient::encodePathParam($id) . "/discovery-domains/" . RawClient::encodePathParam($discoveryDomainId),
                    method: HttpMethod::GET,
                ),
                $options,
            );
