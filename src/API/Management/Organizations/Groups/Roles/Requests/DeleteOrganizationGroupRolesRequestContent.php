...
class DeleteOrganizationGroupRolesRequestContent extends JsonSerializableType
{
    /**
     * @var array<string> $roles Array of role IDs to delete from organization group.
     */
