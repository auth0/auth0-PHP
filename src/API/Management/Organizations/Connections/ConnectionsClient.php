...
use Auth0\SDK\API\Management\Types\ListOrganizationAllConnectionsOffsetPaginatedResponseContent;
...
class ConnectionsClient implements ConnectionsClientInterface
{
    ...
    public function list(string $id, ListOrganizationAllConnectionsRequestParameters $request = new ListOrganizationAllConnectionsRequestParameters(), ?array $options = null): Pager
    {
        return new OffsetPager(
            request: $request,
            getNextPage: fn (ListOrganizationAllConnectionsRequestParameters $request) => $this->_list($id, $request, $options),
            /* @phpstan-ignore-next-line */
            getOffset: fn (ListOrganizationAllConnectionsRequestParameters $request) => $request?->getPage() ?? 0,
    ...
    public function create(string $id, CreateOrganizationAllConnectionRequestParameters $request, ?array $options = null): ?CreateOrganizationAllConnectionResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return CreateOrganizationAllConnectionResponseContent::fromJson($json);
            }
    ...
    public function get(string $id, string $connectionId, ?array $options = null): ?GetOrganizationAllConnectionResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetOrganizationAllConnectionResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
    ...
    public function update(string $id, string $connectionId, UpdateOrganizationConnectionRequestParameters $request = new UpdateOrganizationConnectionRequestParameters(), ?array $options = null): ?UpdateOrganizationAllConnectionResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return UpdateOrganizationAllConnectionResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return ?ListOrganizationAllConnectionsOffsetPaginatedResponseContent
     * @throws Auth0Exception
     * @throws Auth0ApiException
     */
    private function _list(string $id, ListOrganizationAllConnectionsRequestParameters $request = new ListOrganizationAllConnectionsRequestParameters(), ?array $options = null): ?ListOrganizationAllConnectionsOffsetPaginatedResponseContent
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        ...
        if ($request->getIsEnabled() != null) {
            $query['is_enabled'] = $request->getIsEnabled();
        }
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListOrganizationAllConnectionsOffsetPaginatedResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
