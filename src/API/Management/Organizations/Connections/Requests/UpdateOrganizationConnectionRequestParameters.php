...
class UpdateOrganizationConnectionRequestParameters extends JsonSerializableType
{
    ...
    /**
     * @var ?value-of<OrganizationAccessLevelEnumWithNull> $organizationAccessLevel
     */
    ...
    /**
     * @return ?value-of<OrganizationAccessLevelEnumWithNull>
     */
    ...
    /**
     * @param ?value-of<OrganizationAccessLevelEnumWithNull> $value
     */
