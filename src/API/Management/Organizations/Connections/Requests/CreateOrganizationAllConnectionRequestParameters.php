...
namespace Auth0\SDK\API\Management\Organizations\Connections\Requests;

use Auth0\SDK\API\Management\Core\Json\JsonSerializableType;
use Auth0\SDK\API\Management\Core\Json\JsonProperty;
use Auth0\SDK\API\Management\Types\OrganizationAccessLevelEnum;
use Auth0\SDK\API\Management\Types\OrganizationMemberAccessLevelEnum;

class CreateOrganizationAllConnectionRequestParameters extends JsonSerializableType
{
    /**
