...
use Auth0\SDK\API\Management\Types\ListUserAttributeProfilesPaginatedResponseContent;
...
class UserAttributeProfilesClient implements UserAttributeProfilesClientInterface
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    public function list(ListUserAttributeProfileRequestParameters $request = new ListUserAttributeProfileRequestParameters(), ?array $options = null): Pager
    {
        return new CursorPager(
            request: $request,
            getNextPage: fn (ListUserAttributeProfileRequestParameters $request) => $this->_list($request, $options),
            setCursor: function (ListUserAttributeProfileRequestParameters $request, ?string $cursor) {
                $request->setFrom($cursor);
            },
            /* @phpstan-ignore-next-line */
            getNextCursor: fn (?ListUserAttributeProfilesPaginatedResponseContent $response) => $response?->getNext() ?? null,
            /* @phpstan-ignore-next-line */
            getItems: fn (?ListUserAttributeProfilesPaginatedResponseContent $response) => $response?->getUserAttributeProfiles() ?? [],
        );
    }
    ...
    public function create(CreateUserAttributeProfileRequestContent $request, ?array $options = null): ?CreateUserAttributeProfileResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return CreateUserAttributeProfileResponseContent::fromJson($json);
            }
    ...
    public function listTemplates(?array $options = null): ?ListUserAttributeProfileTemplateResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListUserAttributeProfileTemplateResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
    ...
    public function getTemplate(string $id, ?array $options = null): ?GetUserAttributeProfileTemplateResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetUserAttributeProfileTemplateResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
    ...
    public function get(string $id, ?array $options = null): ?GetUserAttributeProfileResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetUserAttributeProfileResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
    ...
    public function update(string $id, UpdateUserAttributeProfileRequestContent $request = new UpdateUserAttributeProfileRequestContent(), ?array $options = null): ?UpdateUserAttributeProfileResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return UpdateUserAttributeProfileResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return ?ListUserAttributeProfilesPaginatedResponseContent
     * @throws Auth0Exception
     * @throws Auth0ApiException
     */
    private function _list(ListUserAttributeProfileRequestParameters $request = new ListUserAttributeProfileRequestParameters(), ?array $options = null): ?ListUserAttributeProfilesPaginatedResponseContent
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListUserAttributeProfilesPaginatedResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
