...
class CustomSigningClient implements CustomSigningClientInterface
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    public function get(?array $options = null): ?GetCustomSigningKeysResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetCustomSigningKeysResponseContent::fromJson($json);
            }
    ...
    public function set(SetCustomSigningKeysRequestContent $request, ?array $options = null): ?SetCustomSigningKeysResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return SetCustomSigningKeysResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
