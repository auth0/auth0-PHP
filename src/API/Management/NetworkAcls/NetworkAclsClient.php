...
use Auth0\SDK\API\Management\Types\ListNetworkAclsOffsetPaginatedResponseContent;
...
class NetworkAclsClient implements NetworkAclsClientInterface
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    public function list(ListNetworkAclsRequestParameters $request = new ListNetworkAclsRequestParameters(), ?array $options = null): Pager
    {
        return new OffsetPager(
            request: $request,
            getNextPage: fn (ListNetworkAclsRequestParameters $request) => $this->_list($request, $options),
            /* @phpstan-ignore-next-line */
            getOffset: fn (ListNetworkAclsRequestParameters $request) => $request?->getPage() ?? 0,
    ...
    public function get(string $id, ?array $options = null): ?GetNetworkAclsResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetNetworkAclsResponseContent::fromJson($json);
            }
    ...
    public function set(string $id, SetNetworkAclRequestContent $request, ?array $options = null): ?SetNetworkAclsResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return SetNetworkAclsResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
    ...
    public function update(string $id, UpdateNetworkAclRequestContent $request = new UpdateNetworkAclRequestContent(), ?array $options = null): ?UpdateNetworkAclResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return UpdateNetworkAclResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return ?ListNetworkAclsOffsetPaginatedResponseContent
     * @throws Auth0Exception
     * @throws Auth0ApiException
     */
    private function _list(ListNetworkAclsRequestParameters $request = new ListNetworkAclsRequestParameters(), ?array $options = null): ?ListNetworkAclsOffsetPaginatedResponseContent
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListNetworkAclsOffsetPaginatedResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
