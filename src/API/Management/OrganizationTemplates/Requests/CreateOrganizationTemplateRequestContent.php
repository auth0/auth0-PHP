...
namespace Auth0\SDK\API\Management\OrganizationTemplates\Requests;

use Auth0\SDK\API\Management\Core\Json\JsonSerializableType;
use Auth0\SDK\API\Management\Core\Json\JsonProperty;
use Auth0\SDK\API\Management\Types\OrganizationDeletionBehaviorEnum;
use Auth0\SDK\API\Management\Types\ConnectionDeletionBehaviorEnum;
use Auth0\SDK\API\Management\Types\OrganizationTemplateAllowedStrategyEnum;
use Auth0\SDK\API\Management\Core\Types\ArrayType;
use Auth0\SDK\API\Management\Types\OrganizationTemplateUseForOrganizationDiscovery;
use Auth0\SDK\API\Management\Types\OrganizationTemplateRoleVisibilityPolicy;

class CreateOrganizationTemplateRequestContent extends JsonSerializableType
{
    /**
    ...
    public function __construct(
        ...
        $this->organizationDeletionBehavior = $values['organizationDeletionBehavior'];
        $this->connectionDeletionBehavior = $values['connectionDeletionBehavior'] ?? null;
        $this->enforcePermissionCeiling = $values['enforcePermissionCeiling'];
        $this->enforceSelfAssignmentRestriction = $values['enforceSelfAssignmentRestriction'];
     ...
     */
    public function setOrganizationDeletionBehavior(string $value): self
    {
     ...
     * @param bool $value
     */
    public function setEnforcePermissionCeiling(bool $value): self
    {
     ...
     * @param bool $value
     */
    public function setEnforceSelfAssignmentRestriction(bool $value): self
    {
