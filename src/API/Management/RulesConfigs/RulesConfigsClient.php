...
class RulesConfigsClient implements RulesConfigsClientInterface
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    public function list(?array $options = null): ?array
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return JsonDecoder::decodeArray($json, [RulesConfig::class]); // @phpstan-ignore-line
            }
    ...
    public function set(string $key, SetRulesConfigRequestContent $request, ?array $options = null): ?SetRulesConfigResponseContent
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return SetRulesConfigResponseContent::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new Auth0Exception(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
