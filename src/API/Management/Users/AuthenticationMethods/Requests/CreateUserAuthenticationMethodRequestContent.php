...
{
    /**
     * @var value-of<CreatedUserAuthenticationMethodTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @param array{
     *   type: value-of<CreatedUserAuthenticationMethodTypeEnum>,
     *   name?: ?string,
     *   totpSecret?: ?string,
     *   phoneNumber?: ?string,
     *   email?: ?string,
    ...
    /**
     * @return value-of<CreatedUserAuthenticationMethodTypeEnum>
     */
    ...
    /**
     * @param value-of<CreatedUserAuthenticationMethodTypeEnum> $value
     */
