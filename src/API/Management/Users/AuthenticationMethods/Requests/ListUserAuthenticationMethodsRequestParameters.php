...
class ListUserAuthenticationMethodsRequestParameters extends JsonSerializableType
{
    /**
     * @var ?int $page Page index of the results to return. First page is 0. Default is 0.
     */
    private ?int $page = 0;

    /**
     * @var ?int $perPage Number of results per page. Default is 50.
     */
