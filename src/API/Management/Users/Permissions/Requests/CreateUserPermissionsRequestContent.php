...
class CreateUserPermissionsRequestContent extends JsonSerializableType
{
    /**
     * @var array<PermissionRequestPayload> $permissions List of permissions to add to this user.
     */
