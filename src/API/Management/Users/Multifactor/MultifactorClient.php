...
class MultifactorClient implements MultifactorClientInterface
{
    /**
     * @var array{
     *   baseUrl?: string,
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    ...
                    path: "users/" . RawClient::encodePathParam($id) . "/multifactor/actions/invalidate-remember-browser",
    ...
    public function deleteProvider(string $id, string $provider, ?array $options = null): void
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "users/" . RawClient::encodePathParam($id) . "/multifactor/" . RawClient::encodePathParam($provider),
