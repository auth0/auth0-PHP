...
namespace Auth0\SDK\API\Management\Users\EffectivePermissions\Sources\Roles\Requests;

use Auth0\SDK\API\Management\Core\Json\JsonSerializableType;

class ListUserEffectivePermissionRoleSourceRequestParameters extends JsonSerializableType
{
    /**
