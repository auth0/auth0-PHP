...
class FederatedConnectionsTokensetsClient implements FederatedConnectionsTokensetsClientInterface
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    public function list(string $id, ?array $options = null): ?array
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return JsonDecoder::decodeArray($json, [FederatedConnectionTokenSet::class]); // @phpstan-ignore-line
            }
    ...
    public function delete(string $id, string $tokensetId, ?array $options = null): void
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
                    path: "users/{$id}/federated-connections-tokensets/{$tokensetId}",
