 ...
 */
class CreateConnectionRequestContentIp extends JsonSerializableType
{
    use CreateConnectionCommon;

    /**
     * @var value-of<CreateConnectionRequestContentIpStrategy> $strategy
     */
     ...
     * @param array{
     *   name: string,
     *   strategy: value-of<CreateConnectionRequestContentIpStrategy>,
    ...
    /**
     * @return value-of<CreateConnectionRequestContentIpStrategy>
     */
    ...
    /**
     * @param value-of<CreateConnectionRequestContentIpStrategy> $value
     */
