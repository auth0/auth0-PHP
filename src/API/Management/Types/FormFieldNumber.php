...
class FormFieldNumber extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeNumberConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var ?FormFieldNumberConfig $config
     */
    #[JsonProperty('config')]
    private ?FormFieldNumberConfig $config;
     ...
     *   type: value-of<FormFieldTypeNumberConst>,
    ...
    /**
     * @return value-of<FormFieldTypeNumberConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeNumberConst> $value
     */
     ...
     */
    public function getConfig(): ?FormFieldNumberConfig
    {
        return $this->config;
    }

    /**
     * @param ?FormFieldNumberConfig $value
     */
    public function setConfig(?FormFieldNumberConfig $value = null): self
    {
        $this->config = $value;
