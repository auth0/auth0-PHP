...
class LogStreamHttpResponseSchema extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<LogStreamHttpEnum> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
     ...
     *   type?: ?value-of<LogStreamHttpEnum>,
     *   isPriority?: ?bool,
    ...
    /**
     * @return ?value-of<LogStreamHttpEnum>
     */
    ...
    /**
     * @param ?value-of<LogStreamHttpEnum> $value
     */
     ...
     */
    public function getSink(): ?LogStreamHttpSink
    {
        return $this->sink;
    }

    /**
     * @param ?LogStreamHttpSink $value
     */
    public function setSink(?LogStreamHttpSink $value = null): self
    {
        $this->sink = $value;
        $this->_setField('sink');
        return $this;
