...
class ListFlowsVaultConnectionsOffsetPaginatedResponseContent extends JsonSerializableType
{
    /**
     * @var ?float $start
     */
    ...
    /**
     * @var ?array<FlowsVaultConnectionSummary> $connections
     */
    #[JsonProperty('connections'), ArrayType([FlowsVaultConnectionSummary::class])]
     ...
     *   limit?: ?float,
     *   total?: ?float,
     *   connections?: ?array<FlowsVaultConnectionSummary>,
     * } $values
     */
    ...
    /**
     * @return ?array<FlowsVaultConnectionSummary>
     */
    ...
    /**
     * @param ?array<FlowsVaultConnectionSummary> $value
     */
