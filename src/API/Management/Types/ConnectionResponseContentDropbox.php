 ...
 */
class ConnectionResponseContentDropbox extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentDropboxStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentDropboxStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentDropboxStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentDropboxStrategy> $value
     */
