 ...
 */
class EventStreamCloudEventGroupRoleAssignedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupRoleAssignedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventGroupRoleAssignedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventGroupRoleAssignedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupRoleAssignedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupRoleAssignedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventGroupRoleAssignedData
     */
    public function getData(): EventStreamCloudEventGroupRoleAssignedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventGroupRoleAssignedData $value
     */
    public function setData(EventStreamCloudEventGroupRoleAssignedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
