 ...
 */
class EventStreamCloudEventConnectionCreatedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventConnectionCreatedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventConnectionCreatedData $data
     */
    #[JsonProperty('data')]
     ...
     *   type: value-of<EventStreamCloudEventConnectionCreatedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventConnectionCreatedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventConnectionCreatedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventConnectionCreatedData
     */
    public function getData(): EventStreamCloudEventConnectionCreatedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventConnectionCreatedData $value
     */
    public function setData(EventStreamCloudEventConnectionCreatedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
