...
class FormWidgetRecaptcha extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormWidgetTypeRecaptchaConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var FormWidgetRecaptchaConfig $config
     */
    #[JsonProperty('config')]
     ...
     *   type: value-of<FormWidgetTypeRecaptchaConst>,
    ...
    /**
     * @return value-of<FormWidgetTypeRecaptchaConst>
     */
    ...
    /**
     * @param value-of<FormWidgetTypeRecaptchaConst> $value
     */
    ...
    /**
     * @return FormWidgetRecaptchaConfig
     */
    public function getConfig(): FormWidgetRecaptchaConfig
    {
        return $this->config;
    }

    /**
     * @param FormWidgetRecaptchaConfig $value
     */
    public function setConfig(FormWidgetRecaptchaConfig $value): self
    {
        $this->config = $value;
