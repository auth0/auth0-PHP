 ...
 */
class ConnectionResponseContentAd extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentAdStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentAdStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentAdStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentAdStrategy> $value
     */
