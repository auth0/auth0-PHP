 ...
 * The event content.
 */
class EventStreamCloudEventUserCreatedObject extends JsonSerializableType
{
    /**
     ...
     */
    #[JsonProperty('identities'), ArrayType([new Union(EventStreamCloudEventUserCreatedObjectIdentitiesItemCustom::class, EventStreamCloudEventUserCreatedObjectIdentitiesItemDatabase::class, EventStreamCloudEventUserCreatedObjectIdentitiesItemEnterprise::class, EventStreamCloudEventUserCreatedObjectIdentitiesItemPasswordless::class, EventStreamCloudEventUserCreatedObjectIdentitiesItemSocial::class)])]
