 ...
 */
class EventStreamCloudEventConnectionUpdatedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventConnectionUpdatedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventConnectionUpdatedData $data
     */
    #[JsonProperty('data')]
     ...
     *   type: value-of<EventStreamCloudEventConnectionUpdatedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventConnectionUpdatedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventConnectionUpdatedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventConnectionUpdatedData
     */
    public function getData(): EventStreamCloudEventConnectionUpdatedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventConnectionUpdatedData $value
     */
    public function setData(EventStreamCloudEventConnectionUpdatedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
