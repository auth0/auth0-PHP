...
class FormFieldTel extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeTelConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var ?FormFieldTelConfig $config
     */
    #[JsonProperty('config')]
    private ?FormFieldTelConfig $config;
     ...
     *   type: value-of<FormFieldTypeTelConst>,
    ...
    /**
     * @return value-of<FormFieldTypeTelConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeTelConst> $value
     */
     ...
     */
    public function getConfig(): ?FormFieldTelConfig
    {
        return $this->config;
    }

    /**
     * @param ?FormFieldTelConfig $value
     */
    public function setConfig(?FormFieldTelConfig $value = null): self
    {
        $this->config = $value;
