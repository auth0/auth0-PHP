 ...
 */
class EventStreamCloudEventUserCreatedPreviousObject extends JsonSerializableType
{
    /**
     ...
     */
    #[JsonProperty('identities'), ArrayType([new Union(EventStreamCloudEventUserCreatedPreviousObjectIdentitiesItemCustom::class, EventStreamCloudEventUserCreatedPreviousObjectIdentitiesItemDatabase::class, EventStreamCloudEventUserCreatedPreviousObjectIdentitiesItemEnterprise::class, EventStreamCloudEventUserCreatedPreviousObjectIdentitiesItemPasswordless::class, EventStreamCloudEventUserCreatedPreviousObjectIdentitiesItemSocial::class)])]
