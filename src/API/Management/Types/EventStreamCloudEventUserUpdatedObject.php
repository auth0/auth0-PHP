 ...
 * The event content.
 */
class EventStreamCloudEventUserUpdatedObject extends JsonSerializableType
{
    /**
     ...
     */
    #[JsonProperty('identities'), ArrayType([new Union(EventStreamCloudEventUserUpdatedObjectIdentitiesItemCustom::class, EventStreamCloudEventUserUpdatedObjectIdentitiesItemDatabase::class, EventStreamCloudEventUserUpdatedObjectIdentitiesItemEnterprise::class, EventStreamCloudEventUserUpdatedObjectIdentitiesItemPasswordless::class, EventStreamCloudEventUserUpdatedObjectIdentitiesItemSocial::class)])]
