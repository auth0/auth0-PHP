...
class FlowActionStripeCreateCustomerParams extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?FlowActionStripeTaxId $taxId
     */
    #[JsonProperty('tax_id')]
    private ?FlowActionStripeTaxId $taxId;
     ...
     */
    public function getTaxId(): ?FlowActionStripeTaxId
    {
        return $this->taxId;
    }

    /**
     * @param ?FlowActionStripeTaxId $value
     */
    public function setTaxId(?FlowActionStripeTaxId $value = null): self
    {
        $this->taxId = $value;
        $this->_setField('taxId');
        return $this;
    }
