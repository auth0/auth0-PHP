...
class FlowActionAuth0SendEmail extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FlowActionAuth0SendEmailType> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var value-of<FlowActionAuth0SendEmailAction> $action
     */
    #[JsonProperty('action')]
    ...
    /**
     * @var FlowActionAuth0SendEmailParams $params
     */
    #[JsonProperty('params')]
     ...
     * @param array{
     *   id: string,
     *   type: value-of<FlowActionAuth0SendEmailType>,
     *   action: value-of<FlowActionAuth0SendEmailAction>,
    ...
    /**
     * @return value-of<FlowActionAuth0SendEmailType>
     */
    ...
    /**
     * @param value-of<FlowActionAuth0SendEmailType> $value
     */
    ...
    /**
     * @return value-of<FlowActionAuth0SendEmailAction>
     */
    ...
    /**
     * @param value-of<FlowActionAuth0SendEmailAction> $value
     */
    ...
    /**
     * @return FlowActionAuth0SendEmailParams
     */
    public function getParams(): FlowActionAuth0SendEmailParams
    {
        return $this->params;
    }

    /**
     * @param FlowActionAuth0SendEmailParams $value
     */
    public function setParams(FlowActionAuth0SendEmailParams $value): self
    {
        $this->params = $value;
