 ...
 */
class ConnectionResponseContentVkontakte extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentVkontakteStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentVkontakteStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentVkontakteStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentVkontakteStrategy> $value
     */
