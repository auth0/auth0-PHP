 ...
 */
class ConnectionOptionsAmazon extends JsonSerializableType
{
    ...
    /**
     * @var ?bool $postalCode When enabled, requests the user's postal code from Amazon during authentication. This adds the 'postal_code' scope to the authorization request.
     */
    #[JsonProperty('postal_code')]
    private ?bool $postalCode;

    /**
     * @var ?bool $profile When enabled, requests the user's basic profile information (name, email, user ID) from Amazon during authentication. This scope is always enabled for Amazon connections.
     */
     ...
     * @param ?bool $value
     */
    public function setPostalCode(?bool $value = null): self
    {
