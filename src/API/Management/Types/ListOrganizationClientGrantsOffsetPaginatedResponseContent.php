...
class ListOrganizationClientGrantsOffsetPaginatedResponseContent extends JsonSerializableType
{
    /**
     * @var ?float $start
     */
    ...
    /**
     * @var ?array<OrganizationClientGrant> $clientGrants
     */
    #[JsonProperty('client_grants'), ArrayType([OrganizationClientGrant::class])]
     ...
     *   limit?: ?float,
     *   total?: ?float,
     *   clientGrants?: ?array<OrganizationClientGrant>,
     * } $values
     */
    ...
    /**
     * @return ?array<OrganizationClientGrant>
     */
    ...
    /**
     * @param ?array<OrganizationClientGrant> $value
     */
