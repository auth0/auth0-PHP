 ...
 */
class ConnectionResponseContentGoogleApps extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentGoogleAppsStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentGoogleAppsStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentGoogleAppsStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentGoogleAppsStrategy> $value
     */
