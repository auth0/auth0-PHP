...
class CreateKeysNetworkAclsResponseContent extends JsonSerializableType
{
    /**
     * @var string $id Auth0-generated identifier for the key. Used to reference the key from a Network ACL and to identify it in Tenant Logs.
     */
    #[JsonProperty('id')]
    private string $id;

    /**
     * @var string $name Customer-supplied label with no cryptographic meaning.
     */
    #[JsonProperty('name')]
    private string $name;
