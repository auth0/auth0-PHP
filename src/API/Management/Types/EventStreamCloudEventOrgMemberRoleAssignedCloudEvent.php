 ...
 */
class EventStreamCloudEventOrgMemberRoleAssignedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgMemberRoleAssignedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgMemberRoleAssignedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgMemberRoleAssignedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgMemberRoleAssignedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgMemberRoleAssignedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgMemberRoleAssignedData
     */
    public function getData(): EventStreamCloudEventOrgMemberRoleAssignedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgMemberRoleAssignedData $value
     */
    public function setData(EventStreamCloudEventOrgMemberRoleAssignedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
