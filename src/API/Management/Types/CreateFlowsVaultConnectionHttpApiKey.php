...
class CreateFlowsVaultConnectionHttpApiKey extends JsonSerializableType
{
    /**
    ...
    /**
     * @var FlowsVaultConnectionHttpApiKeySetup $setup
     */
    #[JsonProperty('setup')]
    ...
    /**
     * @return FlowsVaultConnectionHttpApiKeySetup
     */
    public function getSetup(): FlowsVaultConnectionHttpApiKeySetup
    {
        return $this->setup;
    }

    /**
     * @param FlowsVaultConnectionHttpApiKeySetup $value
     */
    public function setSetup(FlowsVaultConnectionHttpApiKeySetup $value): self
    {
        $this->setup = $value;
