 ...
 */
class ConnectionResponseContentEvernoteSandbox extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentEvernoteSandboxStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentEvernoteSandboxStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentEvernoteSandboxStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentEvernoteSandboxStrategy> $value
     */
