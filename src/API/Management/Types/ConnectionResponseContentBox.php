 ...
 */
class ConnectionResponseContentBox extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentBoxStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentBoxStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentBoxStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentBoxStrategy> $value
     */
