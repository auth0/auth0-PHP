 ...
 */
class EventStreamCloudEventOrgGroupRoleDeletedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgGroupRoleDeletedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgGroupRoleDeletedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgGroupRoleDeletedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgGroupRoleDeletedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgGroupRoleDeletedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgGroupRoleDeletedData
     */
    public function getData(): EventStreamCloudEventOrgGroupRoleDeletedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgGroupRoleDeletedData $value
     */
    public function setData(EventStreamCloudEventOrgGroupRoleDeletedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
