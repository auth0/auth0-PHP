 ...
 */
class ConnectionResponseContentOAuth1 extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentOAuth1Strategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentOAuth1Strategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentOAuth1Strategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentOAuth1Strategy> $value
     */
