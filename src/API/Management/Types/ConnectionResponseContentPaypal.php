 ...
 */
class ConnectionResponseContentPaypal extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentPaypalStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentPaypalStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentPaypalStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentPaypalStrategy> $value
     */
