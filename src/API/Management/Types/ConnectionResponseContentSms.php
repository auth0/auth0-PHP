 ...
 */
class ConnectionResponseContentSms extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentSmsStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentSmsStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentSmsStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentSmsStrategy> $value
     */
