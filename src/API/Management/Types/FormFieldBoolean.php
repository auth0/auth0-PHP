...
class FormFieldBoolean extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeBooleanConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var FormFieldBooleanConfig $config
     */
    #[JsonProperty('config')]
     ...
     *   type: value-of<FormFieldTypeBooleanConst>,
    ...
    /**
     * @return value-of<FormFieldTypeBooleanConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeBooleanConst> $value
     */
    ...
    /**
     * @return FormFieldBooleanConfig
     */
    public function getConfig(): FormFieldBooleanConfig
    {
        return $this->config;
    }

    /**
     * @param FormFieldBooleanConfig $value
     */
    public function setConfig(FormFieldBooleanConfig $value): self
    {
        $this->config = $value;
