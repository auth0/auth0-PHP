...
class FormFieldEmail extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeEmailConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var ?FormFieldEmailConfig $config
     */
    #[JsonProperty('config')]
    private ?FormFieldEmailConfig $config;
     ...
     *   type: value-of<FormFieldTypeEmailConst>,
    ...
    /**
     * @return value-of<FormFieldTypeEmailConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeEmailConst> $value
     */
     ...
     */
    public function getConfig(): ?FormFieldEmailConfig
    {
        return $this->config;
    }

    /**
     * @param ?FormFieldEmailConfig $value
     */
    public function setConfig(?FormFieldEmailConfig $value = null): self
    {
        $this->config = $value;
