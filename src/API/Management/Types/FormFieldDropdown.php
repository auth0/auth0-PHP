...
class FormFieldDropdown extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeDropdownConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var ?FormFieldDropdownConfig $config
     */
    #[JsonProperty('config')]
    private ?FormFieldDropdownConfig $config;
     ...
     *   type: value-of<FormFieldTypeDropdownConst>,
    ...
    /**
     * @return value-of<FormFieldTypeDropdownConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeDropdownConst> $value
     */
     ...
     */
    public function getConfig(): ?FormFieldDropdownConfig
    {
        return $this->config;
    }

    /**
     * @param ?FormFieldDropdownConfig $value
     */
    public function setConfig(?FormFieldDropdownConfig $value = null): self
    {
        $this->config = $value;
