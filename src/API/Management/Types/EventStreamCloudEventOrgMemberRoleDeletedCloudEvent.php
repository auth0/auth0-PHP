 ...
 */
class EventStreamCloudEventOrgMemberRoleDeletedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgMemberRoleDeletedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgMemberRoleDeletedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgMemberRoleDeletedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgMemberRoleDeletedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgMemberRoleDeletedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgMemberRoleDeletedData
     */
    public function getData(): EventStreamCloudEventOrgMemberRoleDeletedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgMemberRoleDeletedData $value
     */
    public function setData(EventStreamCloudEventOrgMemberRoleDeletedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
