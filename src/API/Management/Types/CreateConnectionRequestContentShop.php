 ...
 */
class CreateConnectionRequestContentShop extends JsonSerializableType
{
    use CreateConnectionCommon;

    /**
     * @var value-of<CreateConnectionRequestContentShopStrategy> $strategy
     */
     ...
     * @param array{
     *   name: string,
     *   strategy: value-of<CreateConnectionRequestContentShopStrategy>,
    ...
    /**
     * @return value-of<CreateConnectionRequestContentShopStrategy>
     */
    ...
    /**
     * @param value-of<CreateConnectionRequestContentShopStrategy> $value
     */
