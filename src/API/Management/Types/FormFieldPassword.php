...
class FormFieldPassword extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypePasswordConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var FormFieldPasswordConfig $config
     */
    #[JsonProperty('config')]
     ...
     *   type: value-of<FormFieldTypePasswordConst>,
    ...
    /**
     * @return value-of<FormFieldTypePasswordConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypePasswordConst> $value
     */
    ...
    /**
     * @return FormFieldPasswordConfig
     */
    public function getConfig(): FormFieldPasswordConfig
    {
        return $this->config;
    }

    /**
     * @param FormFieldPasswordConfig $value
     */
    public function setConfig(FormFieldPasswordConfig $value): self
    {
        $this->config = $value;
