...
class VerifyCustomDomainResponseContent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $cnameApiKey CNAME API key header.
     */
    #[JsonProperty('cname_api_key')]
    private ?string $cnameApiKey;
    ...
    public function __construct(
        ...
        $this->cnameApiKey = $values['cnameApiKey'] ?? null;
     ...
     * @return ?string
     */
    public function getCnameApiKey(): ?string
    {
     ...
     * @param ?string $value
     */
    public function setCnameApiKey(?string $value = null): self
    {
        $this->cnameApiKey = $value;
        $this->_setField('cnameApiKey');
        return $this;
    }
