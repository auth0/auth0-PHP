 ...
 */
class EventStreamCloudEventGroupUpdatedPreviousObject2 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupUpdatedPreviousObject2TypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     *   name: string,
     *   createdAt: DateTime,
     *   type: value-of<EventStreamCloudEventGroupUpdatedPreviousObject2TypeEnum>,
     *   updatedAt: DateTime,
     *   externalId?: ?string,
     * } $values
     */
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupUpdatedPreviousObject2TypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupUpdatedPreviousObject2TypeEnum> $value
     */
