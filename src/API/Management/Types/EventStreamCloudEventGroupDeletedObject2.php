 ...
 */
class EventStreamCloudEventGroupDeletedObject2 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupDeletedObject2TypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     *   name: string,
     *   createdAt: DateTime,
     *   type: value-of<EventStreamCloudEventGroupDeletedObject2TypeEnum>,
     *   updatedAt: DateTime,
     *   externalId?: ?string,
     * } $values
     */
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupDeletedObject2TypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupDeletedObject2TypeEnum> $value
     */
