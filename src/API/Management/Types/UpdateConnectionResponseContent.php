...
class UpdateConnectionResponseContent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<string> $enabledClients DEPRECATED property. Use the GET /connections/:id/clients endpoint to get the ids of the clients for which the connection is enabled
     */
