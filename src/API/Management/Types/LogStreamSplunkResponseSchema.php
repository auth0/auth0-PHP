...
class LogStreamSplunkResponseSchema extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<LogStreamSplunkEnum> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
     ...
     *   type?: ?value-of<LogStreamSplunkEnum>,
     *   isPriority?: ?bool,
    ...
    /**
     * @return ?value-of<LogStreamSplunkEnum>
     */
    ...
    /**
     * @param ?value-of<LogStreamSplunkEnum> $value
     */
     ...
     */
    public function getSink(): ?LogStreamSplunkSink
    {
        return $this->sink;
    }

    /**
     * @param ?LogStreamSplunkSink $value
     */
    public function setSink(?LogStreamSplunkSink $value = null): self
    {
        $this->sink = $value;
        $this->_setField('sink');
        return $this;
