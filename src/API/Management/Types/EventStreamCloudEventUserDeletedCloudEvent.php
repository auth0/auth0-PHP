 ...
 */
class EventStreamCloudEventUserDeletedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventUserDeletedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventUserDeletedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventUserDeletedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventUserDeletedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventUserDeletedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventUserDeletedData
     */
    public function getData(): EventStreamCloudEventUserDeletedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventUserDeletedData $value
     */
    public function setData(EventStreamCloudEventUserDeletedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
