 ...
 */
class EventStreamCloudEventConnectionDeletedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventConnectionDeletedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventConnectionDeletedData $data
     */
    #[JsonProperty('data')]
     ...
     *   type: value-of<EventStreamCloudEventConnectionDeletedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventConnectionDeletedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventConnectionDeletedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventConnectionDeletedData
     */
    public function getData(): EventStreamCloudEventConnectionDeletedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventConnectionDeletedData $value
     */
    public function setData(EventStreamCloudEventConnectionDeletedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
