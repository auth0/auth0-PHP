 ...
 */
class EventStreamCloudEventOrgConnectionUpdatedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgConnectionUpdatedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgConnectionUpdatedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgConnectionUpdatedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgConnectionUpdatedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgConnectionUpdatedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgConnectionUpdatedData
     */
    public function getData(): EventStreamCloudEventOrgConnectionUpdatedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgConnectionUpdatedData $value
     */
    public function setData(EventStreamCloudEventOrgConnectionUpdatedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
