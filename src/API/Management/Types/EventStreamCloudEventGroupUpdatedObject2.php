 ...
 */
class EventStreamCloudEventGroupUpdatedObject2 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupUpdatedObject2TypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     *   name: string,
     *   createdAt: DateTime,
     *   type: value-of<EventStreamCloudEventGroupUpdatedObject2TypeEnum>,
     *   updatedAt: DateTime,
     *   externalId?: ?string,
     * } $values
     */
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupUpdatedObject2TypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupUpdatedObject2TypeEnum> $value
     */
