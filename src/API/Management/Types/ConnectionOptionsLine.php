 ...
 */
class ConnectionOptionsLine extends JsonSerializableType
{
    ...
    /**
     * @var ?bool $email Permission to request the user's email address from LINE. When enabled, adds the 'email' scope to OAuth requests. Note: LINE requires special approval to access user email addresses.
     */
    #[JsonProperty('email')]
    private ?bool $email;

    /**
     * @var ?bool $profile Permission to request the user's basic profile information from LINE. When enabled, adds the 'profile' scope to OAuth requests. LINE requires this scope to retrieve user display name, profile picture, and status message.
     */
