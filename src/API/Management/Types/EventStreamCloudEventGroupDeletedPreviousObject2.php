 ...
 */
class EventStreamCloudEventGroupDeletedPreviousObject2 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupDeletedPreviousObject2TypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     *   name: string,
     *   createdAt: DateTime,
     *   type: value-of<EventStreamCloudEventGroupDeletedPreviousObject2TypeEnum>,
     *   updatedAt: DateTime,
     *   externalId?: ?string,
     * } $values
     */
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupDeletedPreviousObject2TypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupDeletedPreviousObject2TypeEnum> $value
     */
