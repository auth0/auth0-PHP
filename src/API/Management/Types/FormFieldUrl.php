...
class FormFieldUrl extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeUrlConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var ?FormFieldUrlConfig $config
     */
    #[JsonProperty('config')]
    private ?FormFieldUrlConfig $config;
     ...
     *   type: value-of<FormFieldTypeUrlConst>,
    ...
    /**
     * @return value-of<FormFieldTypeUrlConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeUrlConst> $value
     */
     ...
     */
    public function getConfig(): ?FormFieldUrlConfig
    {
        return $this->config;
    }

    /**
     * @param ?FormFieldUrlConfig $value
     */
    public function setConfig(?FormFieldUrlConfig $value = null): self
    {
        $this->config = $value;
