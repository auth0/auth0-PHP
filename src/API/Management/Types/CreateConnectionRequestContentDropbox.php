 ...
 */
class CreateConnectionRequestContentDropbox extends JsonSerializableType
{
    use CreateConnectionCommon;

    /**
     * @var value-of<CreateConnectionRequestContentDropboxStrategy> $strategy
     */
     ...
     * @param array{
     *   name: string,
     *   strategy: value-of<CreateConnectionRequestContentDropboxStrategy>,
    ...
    /**
     * @return value-of<CreateConnectionRequestContentDropboxStrategy>
     */
    ...
    /**
     * @param value-of<CreateConnectionRequestContentDropboxStrategy> $value
     */
