 ...
 */
class EventStreamCloudEventGroupRoleDeletedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupRoleDeletedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventGroupRoleDeletedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventGroupRoleDeletedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupRoleDeletedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupRoleDeletedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventGroupRoleDeletedData
     */
    public function getData(): EventStreamCloudEventGroupRoleDeletedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventGroupRoleDeletedData $value
     */
    public function setData(EventStreamCloudEventGroupRoleDeletedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
