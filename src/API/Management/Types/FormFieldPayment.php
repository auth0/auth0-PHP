...
class FormFieldPayment extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypePaymentConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var FormFieldPaymentConfig $config
     */
    #[JsonProperty('config')]
     ...
     *   type: value-of<FormFieldTypePaymentConst>,
    ...
    /**
     * @return value-of<FormFieldTypePaymentConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypePaymentConst> $value
     */
    ...
    /**
     * @return FormFieldPaymentConfig
     */
    public function getConfig(): FormFieldPaymentConfig
    {
        return $this->config;
    }

    /**
     * @param FormFieldPaymentConfig $value
     */
    public function setConfig(FormFieldPaymentConfig $value): self
    {
        $this->config = $value;
