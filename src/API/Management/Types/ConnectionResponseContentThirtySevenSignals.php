 ...
 */
class ConnectionResponseContentThirtySevenSignals extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentThirtySevenSignalsStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentThirtySevenSignalsStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentThirtySevenSignalsStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentThirtySevenSignalsStrategy> $value
     */
