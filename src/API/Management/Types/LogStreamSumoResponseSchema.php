...
class LogStreamSumoResponseSchema extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<LogStreamSumoEnum> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
     ...
     *   type?: ?value-of<LogStreamSumoEnum>,
     *   isPriority?: ?bool,
    ...
    /**
     * @return ?value-of<LogStreamSumoEnum>
     */
    ...
    /**
     * @param ?value-of<LogStreamSumoEnum> $value
     */
     ...
     */
    public function getSink(): ?LogStreamSumoSink
    {
        return $this->sink;
    }

    /**
     * @param ?LogStreamSumoSink $value
     */
    public function setSink(?LogStreamSumoSink $value = null): self
    {
        $this->sink = $value;
        $this->_setField('sink');
        return $this;
