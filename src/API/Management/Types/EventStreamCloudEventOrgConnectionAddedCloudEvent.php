 ...
 */
class EventStreamCloudEventOrgConnectionAddedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgConnectionAddedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgConnectionAddedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgConnectionAddedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgConnectionAddedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgConnectionAddedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgConnectionAddedData
     */
    public function getData(): EventStreamCloudEventOrgConnectionAddedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgConnectionAddedData $value
     */
    public function setData(EventStreamCloudEventOrgConnectionAddedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
