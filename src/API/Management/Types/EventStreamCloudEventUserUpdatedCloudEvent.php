 ...
 */
class EventStreamCloudEventUserUpdatedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventUserUpdatedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventUserUpdatedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventUserUpdatedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventUserUpdatedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventUserUpdatedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventUserUpdatedData
     */
    public function getData(): EventStreamCloudEventUserUpdatedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventUserUpdatedData $value
     */
    public function setData(EventStreamCloudEventUserUpdatedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
