 ...
 */
class ConnectionsOidcMetadata extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<string> $displayValuesSupported JSON array containing a list of the display parameter values that the OpenID Provider supports. These values are described in Section 3.1.2.1 of OpenID Connect Core 1.0 [OpenID.Core]
     */
    ...
    public function __construct(
        ...
        $this->idTokenSigningAlgValuesSupported = $values['idTokenSigningAlgValuesSupported'] ?? null;
     ...
     * @param ?array<string> $value
     */
    public function setIdTokenSigningAlgValuesSupported(?array $value = null): self
    {
