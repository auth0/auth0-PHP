 ...
 */
class ConnectionResponseContentGitHub extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentGitHubStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentGitHubStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentGitHubStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentGitHubStrategy> $value
     */
