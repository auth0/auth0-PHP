...
class CreateEventStreamEventBridgeRequestContent extends JsonSerializableType
{
    /**
     ...
     */
    public function setDestination(EventStreamEventBridgeDestination $value): self
    {
