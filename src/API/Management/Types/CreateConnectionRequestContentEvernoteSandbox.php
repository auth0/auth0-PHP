 ...
 */
class CreateConnectionRequestContentEvernoteSandbox extends JsonSerializableType
{
    use CreateConnectionCommon;

    /**
     * @var value-of<CreateConnectionRequestContentEvernoteSandboxStrategy> $strategy
     */
     ...
     * @param array{
     *   name: string,
     *   strategy: value-of<CreateConnectionRequestContentEvernoteSandboxStrategy>,
    ...
    /**
     * @return value-of<CreateConnectionRequestContentEvernoteSandboxStrategy>
     */
    ...
    /**
     * @param value-of<CreateConnectionRequestContentEvernoteSandboxStrategy> $value
     */
