 ...
 */
class EventStreamCloudEventUserUpdatedPreviousObject extends JsonSerializableType
{
    /**
     ...
     */
    #[JsonProperty('identities'), ArrayType([new Union(EventStreamCloudEventUserUpdatedPreviousObjectIdentitiesItemCustom::class, EventStreamCloudEventUserUpdatedPreviousObjectIdentitiesItemDatabase::class, EventStreamCloudEventUserUpdatedPreviousObjectIdentitiesItemEnterprise::class, EventStreamCloudEventUserUpdatedPreviousObjectIdentitiesItemPasswordless::class, EventStreamCloudEventUserUpdatedPreviousObjectIdentitiesItemSocial::class)])]
