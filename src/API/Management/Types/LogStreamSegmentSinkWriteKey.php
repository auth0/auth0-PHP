...
class LogStreamSegmentSinkWriteKey extends JsonSerializableType
{
    /**
    ...
    public function __construct(
        ...
        $this->segmentWriteKey = $values['segmentWriteKey'];
    }
     ...
     * @param string $value
     */
    public function setSegmentWriteKey(string $value): self
    {
