...
class LogStreamDatadogResponseSchema extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<LogStreamDatadogEnum> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
     ...
     *   type?: ?value-of<LogStreamDatadogEnum>,
     *   isPriority?: ?bool,
    ...
    /**
     * @return ?value-of<LogStreamDatadogEnum>
     */
    ...
    /**
     * @param ?value-of<LogStreamDatadogEnum> $value
     */
     ...
     */
    public function getSink(): ?LogStreamDatadogSink
    {
        return $this->sink;
    }

    /**
     * @param ?LogStreamDatadogSink $value
     */
    public function setSink(?LogStreamDatadogSink $value = null): self
    {
        $this->sink = $value;
        $this->_setField('sink');
        return $this;
