...
class FlowActionAuth0CreateUser extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FlowActionAuth0CreateUserType> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var value-of<FlowActionAuth0CreateUserAction> $action
     */
    #[JsonProperty('action')]
    ...
    /**
     * @var FlowActionAuth0CreateUserParams $params
     */
    #[JsonProperty('params')]
     ...
     * @param array{
     *   id: string,
     *   type: value-of<FlowActionAuth0CreateUserType>,
     *   action: value-of<FlowActionAuth0CreateUserAction>,
    ...
    /**
     * @return value-of<FlowActionAuth0CreateUserType>
     */
    ...
    /**
     * @param value-of<FlowActionAuth0CreateUserType> $value
     */
    ...
    /**
     * @return value-of<FlowActionAuth0CreateUserAction>
     */
    ...
    /**
     * @param value-of<FlowActionAuth0CreateUserAction> $value
     */
    ...
    /**
     * @return FlowActionAuth0CreateUserParams
     */
    public function getParams(): FlowActionAuth0CreateUserParams
    {
        return $this->params;
    }

    /**
     * @param FlowActionAuth0CreateUserParams $value
     */
    public function setParams(FlowActionAuth0CreateUserParams $value): self
    {
        $this->params = $value;
