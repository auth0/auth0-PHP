...
class CreateFlowsVaultConnectionHttpBearer extends JsonSerializableType
{
    /**
    ...
    /**
     * @var FlowsVaultConnectioSetupHttpBearer $setup
     */
    #[JsonProperty('setup')]
    ...
    /**
     * @return FlowsVaultConnectioSetupHttpBearer
     */
    public function getSetup(): FlowsVaultConnectioSetupHttpBearer
    {
        return $this->setup;
    }

    /**
     * @param FlowsVaultConnectioSetupHttpBearer $value
     */
    public function setSetup(FlowsVaultConnectioSetupHttpBearer $value): self
    {
        $this->setup = $value;
