 ...
 */
class CreateUserAuthenticationMethodResponseContent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $keyId Applies to webauthn authenticators only. The id of the credential.
     */
    #[JsonProperty('key_id')]
    private ?string $keyId;

    /**
     * @var ?string $publicKey Applies to webauthn authenticators only. The public key.
     */
    ...
    /**
     * @var ?string $relyingPartyIdentifier Applies to webauthn authenticators only. The relying party identifier.
     */
