 ...
 */
class ConnectionResponseContentFacebook extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentFacebookStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentFacebookStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentFacebookStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentFacebookStrategy> $value
     */
