...
{
    /**
     * @var string $connection The name of the connection for the identity.
     */
    ...
    /**
     * @var ?bool $isSocial <code>true</code> if the identity provider is a social provider, <code>false</code>s otherwise
     */
