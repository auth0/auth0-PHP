 ...
 */
class EventStreamCloudEventOrgUpdatedPreviousObject extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?EventStreamCloudEventOrgUpdatedPreviousObjectBranding $branding
     */
    #[JsonProperty('branding')]
    private ?EventStreamCloudEventOrgUpdatedPreviousObjectBranding $branding;
    ...
    /**
     * @return ?EventStreamCloudEventOrgUpdatedPreviousObjectBranding
     */
    public function getBranding(): ?EventStreamCloudEventOrgUpdatedPreviousObjectBranding
    {
        return $this->branding;
    }

    /**
     * @param ?EventStreamCloudEventOrgUpdatedPreviousObjectBranding $value
     */
    public function setBranding(?EventStreamCloudEventOrgUpdatedPreviousObjectBranding $value = null): self
    {
        $this->branding = $value;
