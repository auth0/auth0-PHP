 ...
 */
class CreateConnectionRequestContentVkontakte extends JsonSerializableType
{
    use CreateConnectionCommon;

    /**
     * @var value-of<CreateConnectionRequestContentVkontakteStrategy> $strategy
     */
     ...
     * @param array{
     *   name: string,
     *   strategy: value-of<CreateConnectionRequestContentVkontakteStrategy>,
    ...
    /**
     * @return value-of<CreateConnectionRequestContentVkontakteStrategy>
     */
    ...
    /**
     * @param value-of<CreateConnectionRequestContentVkontakteStrategy> $value
     */
