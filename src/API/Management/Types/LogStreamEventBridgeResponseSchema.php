...
class LogStreamEventBridgeResponseSchema extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<LogStreamEventBridgeEnum> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LogStreamEventBridgeSink $sink
     */
    #[JsonProperty('sink')]
     ...
     *   type?: ?value-of<LogStreamEventBridgeEnum>,
     *   isPriority?: ?bool,
    ...
    /**
     * @return ?value-of<LogStreamEventBridgeEnum>
     */
    ...
    /**
     * @param ?value-of<LogStreamEventBridgeEnum> $value
     */
     ...
     */
    public function getSink(): ?LogStreamEventBridgeSink
    {
        return $this->sink;
    }

    /**
     * @param ?LogStreamEventBridgeSink $value
     */
    public function setSink(?LogStreamEventBridgeSink $value = null): self
    {
        $this->sink = $value;
        $this->_setField('sink');
        return $this;
