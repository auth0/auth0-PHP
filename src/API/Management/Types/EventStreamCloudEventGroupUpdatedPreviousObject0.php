 ...
 */
class EventStreamCloudEventGroupUpdatedPreviousObject0 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupUpdatedPreviousObject0TypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     *   name: string,
     *   createdAt: DateTime,
     *   type: value-of<EventStreamCloudEventGroupUpdatedPreviousObject0TypeEnum>,
     *   connectionId: string,
     *   updatedAt: DateTime,
     *   externalId?: ?string,
     * } $values
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupUpdatedPreviousObject0TypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupUpdatedPreviousObject0TypeEnum> $value
     */
