 ...
 */
class EventStreamCloudEventGroupDeletedPreviousObject0 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupDeletedPreviousObject0TypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     *   name: string,
     *   createdAt: DateTime,
     *   type: value-of<EventStreamCloudEventGroupDeletedPreviousObject0TypeEnum>,
     *   connectionId: string,
     *   updatedAt: DateTime,
     *   externalId?: ?string,
     * } $values
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupDeletedPreviousObject0TypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupDeletedPreviousObject0TypeEnum> $value
     */
