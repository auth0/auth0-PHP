...
class FormFieldDate extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeDateConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var FormFieldDateConfig $config
     */
    #[JsonProperty('config')]
     ...
     *   type: value-of<FormFieldTypeDateConst>,
    ...
    /**
     * @return value-of<FormFieldTypeDateConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeDateConst> $value
     */
    ...
    /**
     * @return FormFieldDateConfig
     */
    public function getConfig(): FormFieldDateConfig
    {
        return $this->config;
    }

    /**
     * @param FormFieldDateConfig $value
     */
    public function setConfig(FormFieldDateConfig $value): self
    {
        $this->config = $value;
