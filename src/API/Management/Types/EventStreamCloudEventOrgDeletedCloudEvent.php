 ...
 */
class EventStreamCloudEventOrgDeletedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgDeletedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgDeletedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgDeletedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgDeletedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgDeletedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgDeletedData
     */
    public function getData(): EventStreamCloudEventOrgDeletedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgDeletedData $value
     */
    public function setData(EventStreamCloudEventOrgDeletedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
