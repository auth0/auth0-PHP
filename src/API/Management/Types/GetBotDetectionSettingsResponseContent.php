...
class GetBotDetectionSettingsResponseContent extends JsonSerializableType
{
    /**
    ...
    public function __construct(
        ...
        $this->botDetectionLevel = $values['botDetectionLevel'];
        $this->challengePasswordPolicy = $values['challengePasswordPolicy'];
        $this->challengePasswordlessPolicy = $values['challengePasswordlessPolicy'];
        $this->challengePasswordResetPolicy = $values['challengePasswordResetPolicy'];
        $this->allowlist = $values['allowlist'];
        $this->monitoringModeEnabled = $values['monitoringModeEnabled'];
    }
     ...
     */
    public function setBotDetectionLevel(string $value): self
    {
     ...
     */
    public function setChallengePasswordPolicy(string $value): self
    {
     ...
     */
    public function setChallengePasswordlessPolicy(string $value): self
    {
     ...
     */
    public function setChallengePasswordResetPolicy(string $value): self
    {
     ...
     */
    public function setAllowlist(array $value): self
    {
     ...
     * @param bool $value
     */
    public function setMonitoringModeEnabled(bool $value): self
    {
