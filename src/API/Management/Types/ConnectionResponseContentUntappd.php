 ...
 */
class ConnectionResponseContentUntappd extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentUntappdStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentUntappdStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentUntappdStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentUntappdStrategy> $value
     */
