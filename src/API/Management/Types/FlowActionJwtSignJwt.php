...
class FlowActionJwtSignJwt extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FlowActionJwtSignJwtType> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var value-of<FlowActionJwtSignJwtAction> $action
     */
    #[JsonProperty('action')]
    ...
    /**
     * @var FlowActionJwtSignJwtParams $params
     */
    #[JsonProperty('params')]
     ...
     * @param array{
     *   id: string,
     *   type: value-of<FlowActionJwtSignJwtType>,
     *   action: value-of<FlowActionJwtSignJwtAction>,
    ...
    /**
     * @return value-of<FlowActionJwtSignJwtType>
     */
    ...
    /**
     * @param value-of<FlowActionJwtSignJwtType> $value
     */
    ...
    /**
     * @return value-of<FlowActionJwtSignJwtAction>
     */
    ...
    /**
     * @param value-of<FlowActionJwtSignJwtAction> $value
     */
    ...
    /**
     * @return FlowActionJwtSignJwtParams
     */
    public function getParams(): FlowActionJwtSignJwtParams
    {
        return $this->params;
    }

    /**
     * @param FlowActionJwtSignJwtParams $value
     */
    public function setParams(FlowActionJwtSignJwtParams $value): self
    {
        $this->params = $value;
