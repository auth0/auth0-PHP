 ...
 */
class ConnectionResponseContentWeibo extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentWeiboStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentWeiboStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentWeiboStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentWeiboStrategy> $value
     */
