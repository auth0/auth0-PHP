 ...
 */
class ConnectionResponseContentInstagram extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentInstagramStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentInstagramStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentInstagramStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentInstagramStrategy> $value
     */
