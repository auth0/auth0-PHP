 ...
 */
class EventStreamCloudEventGroupDeletedObject0 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupDeletedObject0TypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     *   name: string,
     *   createdAt: DateTime,
     *   type: value-of<EventStreamCloudEventGroupDeletedObject0TypeEnum>,
     *   connectionId: string,
     *   updatedAt: DateTime,
     *   externalId?: ?string,
     * } $values
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupDeletedObject0TypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupDeletedObject0TypeEnum> $value
     */
