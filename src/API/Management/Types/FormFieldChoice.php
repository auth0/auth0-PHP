...
class FormFieldChoice extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeChoiceConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var ?FormFieldChoiceConfig $config
     */
    #[JsonProperty('config')]
    private ?FormFieldChoiceConfig $config;
     ...
     *   type: value-of<FormFieldTypeChoiceConst>,
    ...
    /**
     * @return value-of<FormFieldTypeChoiceConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeChoiceConst> $value
     */
     ...
     */
    public function getConfig(): ?FormFieldChoiceConfig
    {
        return $this->config;
    }

    /**
     * @param ?FormFieldChoiceConfig $value
     */
    public function setConfig(?FormFieldChoiceConfig $value = null): self
    {
        $this->config = $value;
