...
class ListUserGrantsOffsetPaginatedResponseContent extends JsonSerializableType
{
    /**
     * @var ?float $start
     */
    ...
    /**
     * @var ?array<UserGrant> $grants
     */
    #[JsonProperty('grants'), ArrayType([UserGrant::class])]
