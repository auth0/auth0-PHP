...
class FormFieldFile extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeFileConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var ?FormFieldFileConfig $config
     */
    #[JsonProperty('config')]
    private ?FormFieldFileConfig $config;
     ...
     *   type: value-of<FormFieldTypeFileConst>,
    ...
    /**
     * @return value-of<FormFieldTypeFileConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeFileConst> $value
     */
     ...
     */
    public function getConfig(): ?FormFieldFileConfig
    {
        return $this->config;
    }

    /**
     * @param ?FormFieldFileConfig $value
     */
    public function setConfig(?FormFieldFileConfig $value = null): self
    {
        $this->config = $value;
