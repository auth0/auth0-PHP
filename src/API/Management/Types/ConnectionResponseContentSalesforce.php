 ...
 */
class ConnectionResponseContentSalesforce extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentSalesforceStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentSalesforceStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentSalesforceStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentSalesforceStrategy> $value
     */
