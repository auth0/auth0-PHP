 ...
 */
class CreateConnectionRequestContentAuth0 extends JsonSerializableType
{
    use CreateConnectionCommon;

    /**
     * @var value-of<CreateConnectionRequestContentAuth0Strategy> $strategy
     */
     ...
     * @param array{
     *   name: string,
     *   strategy: value-of<CreateConnectionRequestContentAuth0Strategy>,
    ...
    /**
     * @return value-of<CreateConnectionRequestContentAuth0Strategy>
     */
    ...
    /**
     * @param value-of<CreateConnectionRequestContentAuth0Strategy> $value
     */
