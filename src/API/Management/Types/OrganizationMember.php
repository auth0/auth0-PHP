...
class OrganizationMember extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<OrganizationMemberRole> $roles
     */
    #[JsonProperty('roles'), ArrayType([OrganizationMemberRole::class])]
    private ?array $roles;
    ...
    /**
     * @return ?array<OrganizationMemberRole>
     */
    ...
    /**
     * @param ?array<OrganizationMemberRole> $value
     */
