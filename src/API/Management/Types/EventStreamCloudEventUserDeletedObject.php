 ...
 * The event content.
 */
class EventStreamCloudEventUserDeletedObject extends JsonSerializableType
{
    /**
     ...
     * )> $identities Array of user identity objects when accounts are linked.
     */
    #[JsonProperty('identities'), ArrayType([new Union(EventStreamCloudEventUserDeletedObjectIdentitiesItemCustom::class, EventStreamCloudEventUserDeletedObjectIdentitiesItemDatabase::class, EventStreamCloudEventUserDeletedObjectIdentitiesItemEnterprise::class, EventStreamCloudEventUserDeletedObjectIdentitiesItemPasswordless::class, EventStreamCloudEventUserDeletedObjectIdentitiesItemSocial::class)])]
    ...
    /**
     * @var ?DateTime $lastLogin Last date and time this user logged in (ISO_8601 format).
     */
    ...
    /**
     * @var DateTime $deletedAt Date and time when this entity was deleted (ISO_8601 format).
     */
    ...
    public function __construct(
        ...
        $this->identities = $values['identities'];
     ...
     * )> $value
     */
    public function setIdentities(array $value): self
    {
