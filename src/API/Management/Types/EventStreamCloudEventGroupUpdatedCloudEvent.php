 ...
 */
class EventStreamCloudEventGroupUpdatedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupUpdatedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventGroupUpdatedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventGroupUpdatedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupUpdatedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupUpdatedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventGroupUpdatedData
     */
    public function getData(): EventStreamCloudEventGroupUpdatedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventGroupUpdatedData $value
     */
    public function setData(EventStreamCloudEventGroupUpdatedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
