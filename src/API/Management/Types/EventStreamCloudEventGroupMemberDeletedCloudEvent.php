 ...
 */
class EventStreamCloudEventGroupMemberDeletedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupMemberDeletedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventGroupMemberDeletedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventGroupMemberDeletedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupMemberDeletedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupMemberDeletedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventGroupMemberDeletedData
     */
    public function getData(): EventStreamCloudEventGroupMemberDeletedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventGroupMemberDeletedData $value
     */
    public function setData(EventStreamCloudEventGroupMemberDeletedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
