...
class ListRolePermissionsOffsetPaginatedResponseContent extends JsonSerializableType
{
    /**
     * @var ?float $start
     */
    ...
    /**
     * @var ?array<PermissionsResponsePayload> $permissions
     */
    #[JsonProperty('permissions'), ArrayType([PermissionsResponsePayload::class])]
     ...
     *   limit?: ?float,
     *   total?: ?float,
     *   permissions?: ?array<PermissionsResponsePayload>,
     * } $values
     */
    ...
    /**
     * @return ?array<PermissionsResponsePayload>
     */
    ...
    /**
     * @param ?array<PermissionsResponsePayload> $value
     */
