...
class CreateOrganizationResponseContent extends JsonSerializableType
{
    /**
    ...
    /**
     * @return ?array<OrganizationEnabledConnection>
     */
    ...
    /**
     * @param ?array<OrganizationEnabledConnection> $value
     */
