 ...
 */
class ConnectionResponseContentOAuth2 extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentOAuth2Strategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentOAuth2Strategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentOAuth2Strategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentOAuth2Strategy> $value
     */
