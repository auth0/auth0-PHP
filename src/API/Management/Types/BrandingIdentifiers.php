 ...
 */
class BrandingIdentifiers extends JsonSerializableType
{
    /**
     * @var ?value-of<BrandingLoginDisplayEnum> $loginDisplay
     */
    ...
    /**
     * @var ?BrandingPhoneDisplay $phoneDisplay
     */
    #[JsonProperty('phone_display')]
    private ?BrandingPhoneDisplay $phoneDisplay;

    /**
     * @param array{
     *   loginDisplay?: ?value-of<BrandingLoginDisplayEnum>,
     *   otpAutocomplete?: ?bool,
     *   phoneDisplay?: ?BrandingPhoneDisplay,
     * } $values
     */
    ...
    /**
     * @return ?value-of<BrandingLoginDisplayEnum>
     */
    ...
    /**
     * @param ?value-of<BrandingLoginDisplayEnum> $value
     */
     ...
     */
    public function getPhoneDisplay(): ?BrandingPhoneDisplay
    {
        return $this->phoneDisplay;
    }

    /**
     * @param ?BrandingPhoneDisplay $value
     */
    public function setPhoneDisplay(?BrandingPhoneDisplay $value = null): self
    {
