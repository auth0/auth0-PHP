 ...
 */
class ConnectionResponseContentAuth0 extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentAuth0Strategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentAuth0Strategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentAuth0Strategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentAuth0Strategy> $value
     */
