 ...
 */
class CreateConnectionRequestContentPaypalSandbox extends JsonSerializableType
{
    use CreateConnectionCommon;

    /**
     * @var value-of<CreateConnectionRequestContentPaypalSandboxStrategy> $strategy
     */
     ...
     * @param array{
     *   name: string,
     *   strategy: value-of<CreateConnectionRequestContentPaypalSandboxStrategy>,
    ...
    /**
     * @return value-of<CreateConnectionRequestContentPaypalSandboxStrategy>
     */
    ...
    /**
     * @param value-of<CreateConnectionRequestContentPaypalSandboxStrategy> $value
     */
