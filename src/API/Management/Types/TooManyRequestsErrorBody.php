...
class TooManyRequestsErrorBody extends JsonSerializableType
{
    ...
    /**
     * @var value-of<TooManyRequestsErrorBodyError> $error
     */
    #[JsonProperty('error')]
     ...
     *   message: string,
     *   statusCode: string,
     *   error: value-of<TooManyRequestsErrorBodyError>,
     * } $values
     */
    ...
    /**
     * @return value-of<TooManyRequestsErrorBodyError>
     */
    ...
    /**
     * @param value-of<TooManyRequestsErrorBodyError> $value
     */
