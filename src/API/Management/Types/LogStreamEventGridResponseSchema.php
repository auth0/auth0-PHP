...
class LogStreamEventGridResponseSchema extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<LogStreamEventGridEnum> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LogStreamEventGridSink $sink
     */
    #[JsonProperty('sink')]
     ...
     *   type?: ?value-of<LogStreamEventGridEnum>,
     *   isPriority?: ?bool,
    ...
    /**
     * @return ?value-of<LogStreamEventGridEnum>
     */
    ...
    /**
     * @param ?value-of<LogStreamEventGridEnum> $value
     */
     ...
     */
    public function getSink(): ?LogStreamEventGridSink
    {
        return $this->sink;
    }

    /**
     * @param ?LogStreamEventGridSink $value
     */
    public function setSink(?LogStreamEventGridSink $value = null): self
    {
        $this->sink = $value;
        $this->_setField('sink');
        return $this;
