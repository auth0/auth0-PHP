 ...
 * The event content.
 */
class EventStreamCloudEventOrgCreatedObject extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?EventStreamCloudEventOrgCreatedObjectBranding $branding
     */
    #[JsonProperty('branding')]
    private ?EventStreamCloudEventOrgCreatedObjectBranding $branding;
    ...
    /**
     * @return ?EventStreamCloudEventOrgCreatedObjectBranding
     */
    public function getBranding(): ?EventStreamCloudEventOrgCreatedObjectBranding
    {
        return $this->branding;
    }

    /**
     * @param ?EventStreamCloudEventOrgCreatedObjectBranding $value
     */
    public function setBranding(?EventStreamCloudEventOrgCreatedObjectBranding $value = null): self
    {
        $this->branding = $value;
