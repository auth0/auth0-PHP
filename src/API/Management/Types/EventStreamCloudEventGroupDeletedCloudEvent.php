 ...
 */
class EventStreamCloudEventGroupDeletedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupDeletedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventGroupDeletedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventGroupDeletedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupDeletedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupDeletedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventGroupDeletedData
     */
    public function getData(): EventStreamCloudEventGroupDeletedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventGroupDeletedData $value
     */
    public function setData(EventStreamCloudEventGroupDeletedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
