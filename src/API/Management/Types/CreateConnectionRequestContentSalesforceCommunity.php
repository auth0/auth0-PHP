 ...
 */
class CreateConnectionRequestContentSalesforceCommunity extends JsonSerializableType
{
    use CreateConnectionCommon;

    /**
     * @var value-of<CreateConnectionRequestContentSalesforceCommunityStrategy> $strategy
     */
     ...
     * @param array{
     *   name: string,
     *   strategy: value-of<CreateConnectionRequestContentSalesforceCommunityStrategy>,
    ...
    /**
     * @return value-of<CreateConnectionRequestContentSalesforceCommunityStrategy>
     */
    ...
    /**
     * @param value-of<CreateConnectionRequestContentSalesforceCommunityStrategy> $value
     */
