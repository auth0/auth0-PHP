 ...
 */
class ConnectionResponseContentShop extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentShopStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentShopStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentShopStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentShopStrategy> $value
     */
