 ...
 */
class EventStreamEventBridgeConfiguration extends JsonSerializableType
{
    /**
     * @var string $awsAccountId AWS Account ID for EventBridge destination.
     */
    #[JsonProperty('aws_account_id')]
    private string $awsAccountId;

    /**
     * @var value-of<EventStreamEventBridgeAwsRegionEnum> $awsRegion
     */
    #[JsonProperty('aws_region')]
    private string $awsRegion;

    /**
     * @var ?string $awsPartnerEventSource AWS Partner Event Source for EventBridge destination.
     */
     ...
     * @param array{
     *   awsAccountId: string,
     *   awsRegion: value-of<EventStreamEventBridgeAwsRegionEnum>,
    ...
    /**
     * @return value-of<EventStreamEventBridgeAwsRegionEnum>
     */
    ...
    /**
     * @param value-of<EventStreamEventBridgeAwsRegionEnum> $value
     */
