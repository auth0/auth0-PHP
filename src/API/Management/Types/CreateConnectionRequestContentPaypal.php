 ...
 */
class CreateConnectionRequestContentPaypal extends JsonSerializableType
{
    use CreateConnectionCommon;

    /**
     * @var value-of<CreateConnectionRequestContentPaypalStrategy> $strategy
     */
     ...
     * @param array{
     *   name: string,
     *   strategy: value-of<CreateConnectionRequestContentPaypalStrategy>,
    ...
    /**
     * @return value-of<CreateConnectionRequestContentPaypalStrategy>
     */
    ...
    /**
     * @param value-of<CreateConnectionRequestContentPaypalStrategy> $value
     */
