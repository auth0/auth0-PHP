...
class LogStreamSegmentResponseSchema extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<LogStreamSegmentEnum> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LogStreamSegmentSinkWriteKey $sink
     */
    #[JsonProperty('sink')]
     ...
     *   type?: ?value-of<LogStreamSegmentEnum>,
     *   isPriority?: ?bool,
    ...
    /**
     * @return ?value-of<LogStreamSegmentEnum>
     */
    ...
    /**
     * @param ?value-of<LogStreamSegmentEnum> $value
     */
     ...
     */
    public function getSink(): ?LogStreamSegmentSinkWriteKey
    {
        return $this->sink;
    }

    /**
     * @param ?LogStreamSegmentSinkWriteKey $value
     */
    public function setSink(?LogStreamSegmentSinkWriteKey $value = null): self
    {
        $this->sink = $value;
        $this->_setField('sink');
        return $this;
