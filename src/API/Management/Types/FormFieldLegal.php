...
class FormFieldLegal extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeLegalConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var ?FormFieldLegalConfig $config
     */
    #[JsonProperty('config')]
    private ?FormFieldLegalConfig $config;
     ...
     *   type: value-of<FormFieldTypeLegalConst>,
    ...
    /**
     * @return value-of<FormFieldTypeLegalConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeLegalConst> $value
     */
     ...
     */
    public function getConfig(): ?FormFieldLegalConfig
    {
        return $this->config;
    }

    /**
     * @param ?FormFieldLegalConfig $value
     */
    public function setConfig(?FormFieldLegalConfig $value = null): self
    {
        $this->config = $value;
