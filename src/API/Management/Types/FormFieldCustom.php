...
class FormFieldCustom extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeCustomConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var FormFieldCustomConfig $config
     */
    #[JsonProperty('config')]
     ...
     *   type: value-of<FormFieldTypeCustomConst>,
    ...
    /**
     * @return value-of<FormFieldTypeCustomConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeCustomConst> $value
     */
    ...
    /**
     * @return FormFieldCustomConfig
     */
    public function getConfig(): FormFieldCustomConfig
    {
        return $this->config;
    }

    /**
     * @param FormFieldCustomConfig $value
     */
    public function setConfig(FormFieldCustomConfig $value): self
    {
        $this->config = $value;
