 ...
 */
class EventStreamCloudEventOrgMemberDeletedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgMemberDeletedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgMemberDeletedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgMemberDeletedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgMemberDeletedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgMemberDeletedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgMemberDeletedData
     */
    public function getData(): EventStreamCloudEventOrgMemberDeletedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgMemberDeletedData $value
     */
    public function setData(EventStreamCloudEventOrgMemberDeletedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
