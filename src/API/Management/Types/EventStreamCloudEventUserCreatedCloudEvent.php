 ...
 */
class EventStreamCloudEventUserCreatedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventUserCreatedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventUserCreatedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventUserCreatedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventUserCreatedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventUserCreatedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventUserCreatedData
     */
    public function getData(): EventStreamCloudEventUserCreatedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventUserCreatedData $value
     */
    public function setData(EventStreamCloudEventUserCreatedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
