...
class ListAculsResponseContentItem extends JsonSerializableType
{
    /**
     * @var ?string $tenant Tenant ID
     */
    #[JsonProperty('tenant')]
    private ?string $tenant;

    /**
     * @var ?string $prompt Name of the prompt
     */
    #[JsonProperty('prompt')]
    private ?string $prompt;

    /**
     * @var ?string $screen Name of the screen
     */
    #[JsonProperty('screen')]
