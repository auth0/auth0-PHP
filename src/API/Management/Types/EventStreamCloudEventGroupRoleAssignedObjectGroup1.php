 ...
 */
class EventStreamCloudEventGroupRoleAssignedObjectGroup1 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupRoleAssignedObjectGroup1TypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     * @param array{
     *   id: string,
     *   type: value-of<EventStreamCloudEventGroupRoleAssignedObjectGroup1TypeEnum>,
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupRoleAssignedObjectGroup1TypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupRoleAssignedObjectGroup1TypeEnum> $value
     */
