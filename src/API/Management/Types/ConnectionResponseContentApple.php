 ...
 */
class ConnectionResponseContentApple extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentAppleStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentAppleStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentAppleStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentAppleStrategy> $value
     */
