 ...
 */
class ConnectionResponseContentGoogleOAuth2 extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentGoogleOAuth2Strategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentGoogleOAuth2Strategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentGoogleOAuth2Strategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentGoogleOAuth2Strategy> $value
     */
