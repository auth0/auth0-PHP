 ...
 */
class ConnectionResponseContentTwitter extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentTwitterStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentTwitterStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentTwitterStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentTwitterStrategy> $value
     */
