...
class FormFieldCards extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeCardsConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var ?FormFieldCardsConfig $config
     */
    #[JsonProperty('config')]
    private ?FormFieldCardsConfig $config;
     ...
     *   type: value-of<FormFieldTypeCardsConst>,
    ...
    /**
     * @return value-of<FormFieldTypeCardsConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeCardsConst> $value
     */
     ...
     */
    public function getConfig(): ?FormFieldCardsConfig
    {
        return $this->config;
    }

    /**
     * @param ?FormFieldCardsConfig $value
     */
    public function setConfig(?FormFieldCardsConfig $value = null): self
    {
        $this->config = $value;
