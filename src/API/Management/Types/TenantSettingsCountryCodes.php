 ...
 */
class TenantSettingsCountryCodes extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<TenantSettingsCountryCodesMode> $mode
     */
    #[JsonProperty('mode')]
    private ?string $mode;
     ...
     * @param array{
     *   list?: ?array<string>,
     *   mode?: ?value-of<TenantSettingsCountryCodesMode>,
     * } $values
     */
    ...
    /**
     * @return ?value-of<TenantSettingsCountryCodesMode>
     */
    ...
    /**
     * @param ?value-of<TenantSettingsCountryCodesMode> $value
     */
