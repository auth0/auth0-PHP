 ...
 */
class EventStreamCloudEventGroupCreatedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupCreatedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventGroupCreatedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventGroupCreatedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupCreatedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupCreatedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventGroupCreatedData
     */
    public function getData(): EventStreamCloudEventGroupCreatedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventGroupCreatedData $value
     */
    public function setData(EventStreamCloudEventGroupCreatedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
