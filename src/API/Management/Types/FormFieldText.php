...
class FormFieldText extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<FormFieldTypeTextConst> $type
     */
    #[JsonProperty('type')]
    private string $type;

    /**
     * @var ?FormFieldTextConfig $config
     */
    #[JsonProperty('config')]
    private ?FormFieldTextConfig $config;
     ...
     *   type: value-of<FormFieldTypeTextConst>,
    ...
    /**
     * @return value-of<FormFieldTypeTextConst>
     */
    ...
    /**
     * @param value-of<FormFieldTypeTextConst> $value
     */
     ...
     */
    public function getConfig(): ?FormFieldTextConfig
    {
        return $this->config;
    }

    /**
     * @param ?FormFieldTextConfig $value
     */
    public function setConfig(?FormFieldTextConfig $value = null): self
    {
        $this->config = $value;
