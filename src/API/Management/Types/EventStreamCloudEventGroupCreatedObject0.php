 ...
 */
class EventStreamCloudEventGroupCreatedObject0 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupCreatedObject0TypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     *   name: string,
     *   createdAt: DateTime,
     *   type: value-of<EventStreamCloudEventGroupCreatedObject0TypeEnum>,
     *   connectionId: string,
     *   externalId?: ?string,
     * } $values
     */
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupCreatedObject0TypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupCreatedObject0TypeEnum> $value
     */
