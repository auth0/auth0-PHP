 ...
 */
class EventStreamCloudEventGroupMemberAddedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupMemberAddedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventGroupMemberAddedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventGroupMemberAddedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupMemberAddedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupMemberAddedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventGroupMemberAddedData
     */
    public function getData(): EventStreamCloudEventGroupMemberAddedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventGroupMemberAddedData $value
     */
    public function setData(EventStreamCloudEventGroupMemberAddedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
