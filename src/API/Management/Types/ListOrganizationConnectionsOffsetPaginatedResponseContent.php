...
class ListOrganizationConnectionsOffsetPaginatedResponseContent extends JsonSerializableType
{
    /**
     * @var ?float $start
     */
    ...
    /**
     * @var ?array<OrganizationConnection> $enabledConnections
     */
    #[JsonProperty('enabled_connections'), ArrayType([OrganizationConnection::class])]
     ...
     *   limit?: ?float,
     *   total?: ?float,
     *   enabledConnections?: ?array<OrganizationConnection>,
     * } $values
     */
    ...
    /**
     * @return ?array<OrganizationConnection>
     */
    ...
    /**
     * @param ?array<OrganizationConnection> $value
     */
