 ...
 */
class EventStreamCloudEventOrgGroupRoleAssignedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgGroupRoleAssignedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgGroupRoleAssignedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgGroupRoleAssignedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgGroupRoleAssignedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgGroupRoleAssignedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgGroupRoleAssignedData
     */
    public function getData(): EventStreamCloudEventOrgGroupRoleAssignedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgGroupRoleAssignedData $value
     */
    public function setData(EventStreamCloudEventOrgGroupRoleAssignedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
