 ...
 */
class EventStreamCloudEventOrgConnectionRemovedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgConnectionRemovedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgConnectionRemovedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgConnectionRemovedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgConnectionRemovedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgConnectionRemovedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgConnectionRemovedData
     */
    public function getData(): EventStreamCloudEventOrgConnectionRemovedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgConnectionRemovedData $value
     */
    public function setData(EventStreamCloudEventOrgConnectionRemovedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
