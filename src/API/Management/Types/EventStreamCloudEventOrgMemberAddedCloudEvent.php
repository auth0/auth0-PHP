 ...
 */
class EventStreamCloudEventOrgMemberAddedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgMemberAddedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgMemberAddedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgMemberAddedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgMemberAddedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgMemberAddedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgMemberAddedData
     */
    public function getData(): EventStreamCloudEventOrgMemberAddedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgMemberAddedData $value
     */
    public function setData(EventStreamCloudEventOrgMemberAddedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
