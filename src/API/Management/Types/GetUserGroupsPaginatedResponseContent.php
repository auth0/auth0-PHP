...
class GetUserGroupsPaginatedResponseContent extends JsonSerializableType
{
    /**
     * @var array<UserGroupsResponseSchema> $groups
     */
    #[JsonProperty('groups'), ArrayType([UserGroupsResponseSchema::class])]
    ...
    /**
     * @param array{
     *   groups: array<UserGroupsResponseSchema>,
     *   next?: ?string,
     *   start?: ?float,
     *   limit?: ?float,
     *   total?: ?float,
    ...
    /**
     * @return array<UserGroupsResponseSchema>
     */
    ...
    /**
     * @param array<UserGroupsResponseSchema> $value
     */
