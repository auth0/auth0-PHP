...
class FormFieldTelConfig extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?bool $countryPicker
     */
    #[JsonProperty('country_picker')]
    private ?bool $countryPicker;

    /**
     * @var ?FormFieldTelConfigStrings $strings
     */
    #[JsonProperty('strings')]
    private ?FormFieldTelConfigStrings $strings;
    ...
    public function __construct(
        ...
        $this->countryPicker = $values['countryPicker'] ?? null;
     ...
     * @return ?bool
     */
    public function getCountryPicker(): ?bool
    {
     ...
     * @param ?bool $value
     */
    public function setCountryPicker(?bool $value = null): self
    {
        $this->countryPicker = $value;
        $this->_setField('countryPicker');
        return $this;
    }
     ...
     */
    public function getStrings(): ?FormFieldTelConfigStrings
    {
        return $this->strings;
    }

    /**
     * @param ?FormFieldTelConfigStrings $value
     */
    public function setStrings(?FormFieldTelConfigStrings $value = null): self
    {
        $this->strings = $value;
        $this->_setField('strings');
        return $this;
    }
