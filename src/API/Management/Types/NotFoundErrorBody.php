...
class NotFoundErrorBody extends JsonSerializableType
{
    ...
    /**
     * @var value-of<NotFoundErrorBodyError> $error
     */
    #[JsonProperty('error')]
     ...
     *   message: string,
     *   statusCode: string,
     *   error: value-of<NotFoundErrorBodyError>,
     * } $values
     */
    ...
    /**
     * @return value-of<NotFoundErrorBodyError>
     */
    ...
    /**
     * @param value-of<NotFoundErrorBodyError> $value
     */
