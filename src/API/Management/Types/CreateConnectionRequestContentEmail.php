 ...
 */
class CreateConnectionRequestContentEmail extends JsonSerializableType
{
    use CreateConnectionCommon;

    /**
     * @var value-of<CreateConnectionRequestContentEmailStrategy> $strategy
     */
     ...
     * @param array{
     *   name: string,
     *   strategy: value-of<CreateConnectionRequestContentEmailStrategy>,
    ...
    /**
     * @return value-of<CreateConnectionRequestContentEmailStrategy>
     */
    ...
    /**
     * @param value-of<CreateConnectionRequestContentEmailStrategy> $value
     */
