 ...
 */
class ConnectionResponseContentSoundcloud extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentSoundcloudStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentSoundcloudStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentSoundcloudStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentSoundcloudStrategy> $value
     */
