...
class LogStreamMixpanelSink extends JsonSerializableType
{
    /**
    ...
    public function __construct(
        ...
        $this->mixpanelServiceAccountPassword = $values['mixpanelServiceAccountPassword'];
    }
     ...
     * @param string $value
     */
    public function setMixpanelServiceAccountPassword(string $value): self
    {
