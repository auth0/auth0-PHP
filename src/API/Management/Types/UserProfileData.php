...
class UserProfileData extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $phoneNumber Phone number for this user.
     */
    #[JsonProperty('phone_number')]
    private ?string $phoneNumber;

    /**
     * @var ?bool $phoneVerified Whether this phone number is verified (true) or unverified (false).
     */
