 ...
 */
class ConnectionResponseContentYandex extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentYandexStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentYandexStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentYandexStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentYandexStrategy> $value
     */
