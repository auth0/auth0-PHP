...
class AttackProtectionUpdateCaptchaRecaptchaV2 extends JsonSerializableType
{
    /**
     * @var string $siteKey The site key for the reCAPTCHA v2 provider.
     */
    #[JsonProperty('site_key')]
    private string $siteKey;

    /**
     * @var string $secret The secret key for the reCAPTCHA v2 provider.
     */
    #[JsonProperty('secret')]
