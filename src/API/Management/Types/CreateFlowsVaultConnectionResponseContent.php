...
class CreateFlowsVaultConnectionResponseContent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $environment Flows Vault Connection environment.
     */
     ...
     * @param ?string $value
     */
    public function setEnvironment(?string $value = null): self
    {
        $this->environment = $value;
        $this->_setField('environment');
        return $this;
    }
