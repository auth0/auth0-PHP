 ...
 */
class ConnectionResponseContentAmazon extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentAmazonStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentAmazonStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentAmazonStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentAmazonStrategy> $value
     */
