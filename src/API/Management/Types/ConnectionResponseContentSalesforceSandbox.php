 ...
 */
class ConnectionResponseContentSalesforceSandbox extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentSalesforceSandboxStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentSalesforceSandboxStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentSalesforceSandboxStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentSalesforceSandboxStrategy> $value
     */
