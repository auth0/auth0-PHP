...
class ListHooksOffsetPaginatedResponseContent extends JsonSerializableType
{
    /**
     * @var ?float $start
     */
     ...
     */
    #[JsonProperty('hooks'), ArrayType([Hook::class])]
    private ?array $hooks;
    ...
    /**
     * @param ?array<Hook> $value
     */
    public function setHooks(?array $value = null): self
    {
        $this->hooks = $value;
        $this->_setField('hooks');
        return $this;
    }
