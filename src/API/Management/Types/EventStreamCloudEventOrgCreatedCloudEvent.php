 ...
 */
class EventStreamCloudEventOrgCreatedCloudEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventOrgCreatedCloudEventTypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
    ...
    /**
     * @var EventStreamCloudEventOrgCreatedData $data
     */
    #[JsonProperty('data')]
     ...
     * @param array{
     *   specversion: string,
     *   type: value-of<EventStreamCloudEventOrgCreatedCloudEventTypeEnum>,
     *   source: string,
     *   id: string,
     *   time: DateTime,
    ...
    /**
     * @return value-of<EventStreamCloudEventOrgCreatedCloudEventTypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventOrgCreatedCloudEventTypeEnum> $value
     */
    ...
    /**
     * @return EventStreamCloudEventOrgCreatedData
     */
    public function getData(): EventStreamCloudEventOrgCreatedData
    {
        return $this->data;
    }

    /**
     * @param EventStreamCloudEventOrgCreatedData $value
     */
    public function setData(EventStreamCloudEventOrgCreatedData $value): self
    {
        $this->data = $value;
        $this->_setField('data');
        return $this;
