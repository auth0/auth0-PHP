 ...
 */
class EventStreamCloudEventGroupCreatedPreviousObject0 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<EventStreamCloudEventGroupCreatedPreviousObject0TypeEnum> $type
     */
    #[JsonProperty('type')]
    private string $type;
     ...
     *   name: string,
     *   createdAt: DateTime,
     *   type: value-of<EventStreamCloudEventGroupCreatedPreviousObject0TypeEnum>,
     *   connectionId: string,
     *   externalId?: ?string,
     * } $values
     */
    ...
    /**
     * @return value-of<EventStreamCloudEventGroupCreatedPreviousObject0TypeEnum>
     */
    ...
    /**
     * @param value-of<EventStreamCloudEventGroupCreatedPreviousObject0TypeEnum> $value
     */
