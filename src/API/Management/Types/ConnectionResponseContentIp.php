 ...
 */
class ConnectionResponseContentIp extends JsonSerializableType
{
    use ConnectionPurposes;
    use ConnectionResponseCommon;

    /**
     * @var value-of<ConnectionResponseContentIpStrategy> $strategy
     */
     ...
     *   id: string,
     *   name: string,
     *   strategy: value-of<ConnectionResponseContentIpStrategy>,
    ...
    /**
     * @return value-of<ConnectionResponseContentIpStrategy>
     */
    ...
    /**
     * @param value-of<ConnectionResponseContentIpStrategy> $value
     */
